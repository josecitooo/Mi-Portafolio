  ...
  const footerLinks = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Descargar CV', href: '/Mi-Portafolio/assets/Jose Carlos Fernandez CV.pdf', download: true }, // CV actualizado descargable, contratame jeje        git commit -m "Primera versión del portafolio"
      ],
    },
  ];
